...
static std::unique_ptr<Menu> make_simple(const std::string& name, const std::string& icon_path,
...
template<typename Menu, typename... Args>
static std::unique_ptr<simple<Menu>> make_simple_of(const std::string& name, const std::string& icon_path,
    render::resource_loader& loader,
    Args&&... args)
{
